...
var fdCreateWriteStreamWith = function (opts) {
    return function (fd) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return Data_Function_Uncurried.runFn2(fs.createWriteStream)($$null)({
                fd: fd, 
...
var fdCreateReadStreamWith = function (opts) {
    return function (fd) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return Data_Function_Uncurried.runFn2(fs.createReadStream)($$null)({
                fd: fd, 
                mode: Node_FS_Perms_1.permsToInt(opts.perms), 
                flags: Node_FS.fileFlagsToNode(opts.flags), 
...
var createWriteStreamWith = function (opts) {
    return function (file) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return Data_Function_Uncurried.runFn2(fs.createWriteStream)(nonnull(file))({
                mode: Node_FS_Perms_1.permsToInt(opts.perms), 
                flags: Node_FS.fileFlagsToNode(opts.flags)
            });
        });
...
var createReadStreamWith = function (opts) {
    return function (file) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return Data_Function_Uncurried.runFn2(fs.createReadStream)(nonnull(file))({
                mode: Node_FS_Perms_1.permsToInt(opts.perms), 
                flags: Node_FS.fileFlagsToNode(opts.flags), 
                autoClose: opts.autoClose
            });
