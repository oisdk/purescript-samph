        ...
        var splitOp = function (v) {
            return function (accum) {
                ...
                if (v instanceof Infix && v.value1 instanceof AssocLeft) {
                    var $21 = {};
                    for (var $22 in accum) {
                        if (accum.hasOwnProperty($22)) {
                            $21[$22] = accum[$22];
                        };
                    };
                    $21.lassoc = new Data_List.Cons(v.value0, accum.lassoc);
                    return $21;
                };
                if (v instanceof Infix && v.value1 instanceof AssocRight) {
                    ...
                    $25.rassoc = new Data_List.Cons(v.value0, accum.rassoc);
                    return $25;
                };
                if (v instanceof Prefix) {
                    ...
                    $29.prefix = new Data_List.Cons(v.value0, accum.prefix);
                    return $29;
                };
                if (v instanceof Postfix) {
                    ...
                    $32.postfix = new Data_List.Cons(v.value0, accum.postfix);
                    return $32;
                };
