...
var main = function __do() {
    ...
    fromFile(Data_StrMap.eqStrMap(Data_Eq.eqInt))(Data_StrMap.showStrMap(Data_Show.showInt))("test/Examples/example1")(Samph_Pars.firstPass(Data_Identity.monadIdentity))(Data_StrMap.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("Start", 0), new Data_Tuple.Tuple("Here", 6), new Data_Tuple.Tuple("Clear", 20), new Data_Tuple.Tuple("Loop", 29) ]))();
    ...
    fromFile(Data_StrMap.eqStrMap(Data_Eq.eqInt))(Data_StrMap.showStrMap(Data_Show.showInt))("test/Examples/example3")(Samph_Pars.firstPass(Data_Identity.monadIdentity))(Data_StrMap.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("Foo", 13) ]))();
    fromFile(Data_StrMap.eqStrMap(Data_Eq.eqInt))(Data_StrMap.showStrMap(Data_Show.showInt))("test/Examples/example4")(Samph_Pars.firstPass(Data_Identity.monadIdentity))(Data_StrMap.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("Rep", 3) ]))();
    ...
    fromFile(Data_StrMap.eqStrMap(Data_Eq.eqInt))(Data_StrMap.showStrMap(Data_Show.showInt))("test/Examples/example6")(Samph_Pars.firstPass(Data_Identity.monadIdentity))(Data_StrMap.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("Start", 0), new Data_Tuple.Tuple("Rep", 22) ]))();
    return fromFile(Data_Eq.eqArray(Samph_Types.eqMach))(Data_Show.showArray(Samph_Types.showMach))("test/Examples/example1")(Samph_Pars.program(Data_Identity.monadIdentity))([ new Samph_Types.D0(Samph_Types.BL.value, 192), new Samph_Types.D0(Samph_Types.AL.value, 60), new Samph_Types.D4(Samph_Types.BL.value, Samph_Types.AL.value), new Samph_Types.DB(Samph_Types.AL.value, 123), new Samph_Types.C1(20), new Samph_Types.A4(Samph_Types.AL.value), new Samph_Types.A4(Samph_Types.BL.value), new Samph_Types.C0(6), new Samph_Types.D0(Samph_Types.CL.value, 64), new Samph_Types.D0(Samph_Types.AL.value, 32), new Samph_Types.D0(Samph_Types.BL.value, 192), new Samph_Types.D4(Samph_Types.BL.value, Samph_Types.AL.value), new Samph_Types.A4(Samph_Types.BL.value), new Samph_Types.A5(Samph_Types.CL.value), new Samph_Types.C2(29), new Samph_Types.C0(0) ])();
};
module.exports = {
    Positive: Positive, 
    abs: abs, 
